 ...
 * 类名称：访问方法
 * 类描述：
 * 运行本实例，将依次访问方法staticMethod()、publicMethod()、protectedMethod()和privateMethod(),然后输出到控制台
 * 创建人：陈键
 * 创建时间2019/2/22.21：13
 * 修改备注：Example_03
 * @author  1.1.1
...
//获得所有方法
Method[] declaredMethods = exampleC.getDeclaaredMethods();
for(int i = 0;i < declaerdMethods.length;i++){
